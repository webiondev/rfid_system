...
namespace DB_Test {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class GameDataTable : global::System.Data.TypedTableBase<GameRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public GameRow AddGameRow(string ID) {
        ...
        public partial class GameRow : global::System.Data.DataRow {
            ...
            public string ID {
                get {
                    return ((string)(this[this.tableGame.IDColumn]));
                }
                set {
...
namespace DB_Test.Database1DataSet1TableAdapters {
    ...
    public partial class GameTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Game] ([ID]) VALUES (@ID);\r\nSELECT ID FROM Game WHERE (ID = @I" +
                "D)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Game] SET [ID] = @ID WHERE (([ID] = @Original_ID));\r\nSELECT ID FROM" +
                " Game WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DB_Test.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID FROM dbo.Game";
        ...
        public virtual int Fill(Database1DataSet1.GameDataTable dataTable) {
        ...
        public virtual Database1DataSet1.GameDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.GameDataTable dataTable = new Database1DataSet1.GameDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.GameDataTable dataTable) {
